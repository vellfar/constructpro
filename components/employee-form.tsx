            ...
            <form action={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select name="gender" defaultValue={employee?.gender || ""} required disabled={isPending}>
                    <SelectTrigger>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    name="wageFrequency"
                    defaultValue={employee?.wageFrequency || ""}
                    required
                    disabled={isPending}
                  >
                    <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="date"
                  defaultValue={
                    employee?.dateOfAppointment ? new Date(employee.dateOfAppointment).toISOString().split("T")[0] : ""
                  }
                  required
                  disabled={isPending}
                />
